package com.liangjz.test.myapplication.model.dao;
...
public class BookDao extends AbstractDao<Book, Long> {
    ...
    public static class Properties {
        ...
        public final static Property Cout = new Property(3, int.class, "cout", false, "COUT");
    ...
    protected final void bindValues(DatabaseStatement stmt, Book entity) {
        ...
        stmt.bindLong(4, entity.getCout());
    ...
    public void readEntity(Cursor cursor, Book entity, int offset) {
        ...
        entity.setCout(cursor.getInt(offset + 3));
